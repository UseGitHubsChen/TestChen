		...
		<div class="row">
			...
			<div class="col-md-offset-2 col-md-8 col-sm-12">
				<div class="home-thumb">
					<h1 class="wow fadeInUp" data-wow-delay="0.4s">Welcome to MyCourse</h1>
          			<h3 class="wow fadeInUp" data-wow-delay="0.6s">我们致力于 <strong>为您</strong> 打造 <strong>属于你的</strong>学习方法!</h3>
          			<a href="showcourse?v=list&course_type=course_type" class="btn btn-lg btn-default smoothScroll wow fadeInUp hidden-xs" data-wow-delay="0.8s">Let's begin</a>
        			<a href="../login/login.jsp" class="btn btn-lg btn-success smoothScroll wow fadeInUp" data-wow-delay="1.0s">Let's Sign in</a>
				</div>
			</div>
